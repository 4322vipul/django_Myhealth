...
class monia_image(models.Model):
    image_given_monia=models.ImageField(max_length=64)

    
class image_name_monia(models.Model):  
    name_of_image_monia=models.CharField(max_length=64)
    
    def __str__(self):
        return self.name_of_image_monia
